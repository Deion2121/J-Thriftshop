    ...
    <>
      ...
      {shopOpen && (
        ...
        >
          {/* Sidebar */}
          <div
            className="w-[320px] md:w-[360px] bg-white h-full shadow-2xl overflow-y-auto animate-slideIn relative"
          ...
          {/* Product Grid */}
          <div
            className="flex-1 bg-gray-50 px-6 py-8 overflow-y-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4"
            onClick={(e) => e.stopPropagation()}
          >
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product) => (
                <div
                  key={product.id}
                  className="relative overflow-hidden rounded-2xl cursor-pointer transform transition duration-300 hover:scale-105 hover:shadow-2xl"
